      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find Your BiCycle</h1>
            <p>"Go green, get fit, and save money with Pedal Pro Rentals </p>
            <p>- The easy choice for affordable cycling adventures."</p>
...
<!-- Fun Facts-->
<section class="fun-facts-section" style=" background: rgba(0, 0, 0, 0.4) repeat scroll 0 0;">
...
<!--Testimonial --> 
<section class="section-padding testimonial-section parallex-bg" style="background:none">
  <div class="container div_zindex">
