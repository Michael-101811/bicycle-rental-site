...
<!--Page Header-->
<section class="page-header listing_page"style="background-image:url(../images/contact-page-header-imgs.jpg);">
  <div class="container">
...
{  ?>
      ...
      <aside class="col-md-3 col-md-pull-9">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Recently Listed BiCycles</h5>
          </div>
