...
<!--Page Header-->
<section class="page-header profile_page" style="background-image:url(../images/contact-page-header-imgs.jpg);">
  <div class="container">
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      ...
      <div class="dealer_info" style="float:left">
...
<li>
 ...
 <div class="vehicle_status" style="width: 30%;"> <a href="#" class="btn outline btn-xs">Cancelled</a>
            <div class="clearfix"></div>
        </div>
                ...
                <?php } else { ?>
 <div class="vehicle_status" style="width: 30%;"> <a href="#" class="btn outline btn-xs">Not Confirm yet</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
